 ...
 * viewport, and a centered content column below it. The only thing a page
 * chooses is what the breadcrumb says and how wide the column is — so the
 * header sits in exactly the same place on all of them.
 */
